...
function ProjectManager({ leader, capacity, view, status, bookMark }) {
  ...
  return (
    <ManagerContainer>
      ...
      <ManagerImg src={leader.photo} alt="leader profile" onClick={onClickProfile}></ManagerImg>
      <DescContainer>
        <ManagerText onClick={onClickProfile}>Team Manager</ManagerText>
        <ManagerNickname onClick={onClickProfile}>{leader.nickName}</ManagerNickname>
